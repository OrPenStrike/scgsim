...
HFSS Driven Terminal/Modal, HFSS Eigenmode, and Q3D have current exact-head live
run and resolve evidence. Q2D remains an implementation target, not a capability
claim.
:::
