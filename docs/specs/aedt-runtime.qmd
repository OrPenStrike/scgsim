...
CLC command. The current candidate authors a sheet integrand, then uses
...
cache setup and saved-field analysis. The new inset-sheet expression bytes have not
...
Coplanar owner seams are removed, while true top/sidewall creases remain
boundaries of their respective physical faces. Margins are alternative
