...
HFSS Driven Terminal/Modal and HFSS Eigenmode have current exact-head live run
and resolve evidence. Q3D and Q2D remain implementation targets, not capability
claims.
:::
